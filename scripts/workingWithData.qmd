...
#| Filtering out the information I actually want to use instead of having to srcoll through a full dataset.
filtered <- df %>%
  select(CASEID, REGION, FOCUS, OWNERSHP, SRVC2, SRVC6, O_AGE1, O_AGE1F)
